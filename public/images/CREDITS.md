...
| `home/SDGs01.png` | `/principles` and `/` — storyscroller layouts (`UnnycPrinciplesStoryscroller`, `UnnycHomeStoryscroller`) | olivia@sarapis.org | 09/09/2026. Background removed (transparent PNG) from the same `home/SDGs01.jpeg` purchase above; no other modification. |
